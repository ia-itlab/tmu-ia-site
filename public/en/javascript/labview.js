...
const studios = [
  {
    ...
    professor: ["Yuki KIKUTAKE", "Professor"],
    news: [
      {
        date: "0000-00-00",
    ...
    oc_video_ulr: "https://www.youtube.com/embed/eIB8y8ODnHo"
  },
  {
    ID: "editorial",
    name: "エディティングスタジオ",
    ...
    professor: ["Kiyoshi KUSUMI", "Associate Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Toshihiro KOMMA", "Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Tomohiko MUKAI", "Associate Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ['Tatsuo SUGIMOTO', 'Associate Professor'],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Kumiko KUSHIYAMA", "Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Seokjin KIM", "Associate Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Osamu NAMBA", "Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Verl ADAMS", "Associate Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Keisuke FUJIWARA", "Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Tetsuaki BABA", "Associate Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
  ...
  },
  {
    ...
    professor: ["Keiko KASAMATSU", "Professor"],
    news: [
      {
        date: "0000-00-00",
        text: "現在公開されているニュースはありません。"
...
function changeContent(studioData) {
  $(".labview .left .title .titleText h2").html(studioData["englishName"]);
  ...
  if (studioData["core"] == "media") {
    ...
    $(".labview .left .title .titleText h4.ja").html("Product Design Core");
    // $(".labview .left .title .titleText h4.en").html("Product Design Core");
  }
  //$(".labview .left .info").html(studioData["info"]);
  $(".labview .left .info").html(studioData["englishInfo"]);
