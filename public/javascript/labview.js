...
const studios = [
  ...
  },
  {
    ...
    info:
      "エルゴノミックデザインスタジオでは、プロダクト、サービスやシステムをデザインするために、エビデンスに基づいたデザインを行っています。そのため、デザイン思考を活用したアイデア発想によりプロダクト、サービスやシステムを企画し、それを実現するための仮説を立て、検証します。また、UX（ユーザエクスペリエンス）を分析することにより、人の行動として現れる経験だけでなく、Affectiveな経験を理解し作り出すため、co-creationするためのデザインプロセスを研究しています。",
    englishInfo:
